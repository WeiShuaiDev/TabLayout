...
public class ModethreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modethree);
        initView();
        initData();
    }

    private void initData() {
        ModethreeAdapter adapter = new ModethreeAdapter(getSupportFragmentManager());
    ...
    private class ModethreeAdapter extends FragmentPagerAdapter {
        public String[] mTilte;

        public ModethreeAdapter(FragmentManager fm) {
            super(fm);
