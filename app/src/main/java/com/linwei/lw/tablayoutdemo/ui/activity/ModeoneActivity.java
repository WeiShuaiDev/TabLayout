...
public class ModeoneActivity extends AppCompatActivity {
    ...
    private void initData() {
        ModeOneAdapter adapter = new ModeOneAdapter(getSupportFragmentManager());
    ...
    private class ModeOneAdapter extends FragmentPagerAdapter {
        public String[] mTilte;

        public ModeOneAdapter(FragmentManager fm) {
            super(fm);
